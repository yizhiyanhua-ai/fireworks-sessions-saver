...
### 查看多项目看板
说任意一种：
- `查看所有 session` / `多项目看板` / `哪些项目在跑`
- `dashboard` / `show all sessions`
...
python3 ~/.claude/skills/fireworks-sessions-saver/scripts/dashboard.py --all   # 含过期
```

### 对比两次 checkpoint
说任意一种：
- `对比进度` / `两次 checkpoint 有什么变化` / `checkpoint 差异`
